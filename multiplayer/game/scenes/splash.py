...
class SplashScene(Scene):
    ...
    def __init__(self):
        ...
        self.alpha_start = 0
        self.alpha_end = 255
        self.fade_in_duration = 3000  # in milliseconds
        self.fade_out_duration = 3000  # in milliseconds
        self.hold_duration = 250
    ...
    def draw(self, screen):
        ...
        screen.blit(self.label, (SCREEN_WIDTH//2 - self.label.get_width()//2, SCREEN_HEIGHT//2 + self.logo.get_height()//2 + 65))
    ...
    def update(self):
        ...
        elif elapsed_time < (self.fade_in_duration + self.fade_out_duration + self.hold_duration):
            ...
        else:
            self.done = True
